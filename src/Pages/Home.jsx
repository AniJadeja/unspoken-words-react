...
const Home = () => {
  ...
  const calculateHeights = () => {
    ...
    if (navBar && footer && introText) {
      ...
      if (avialableWidth.current < 449) {
        setDottedDivisionHeight(70);
        imageHeight.current = ((avialableHeight.current * 50) / 100)
      }
      else if (avialableWidth.current > 449 && availableWidth.current < 560) {
        imageHeight.current = ((avialableHeight.current * 60) / 100)
      }
      else if ( availableWidth.current > 560 && avialableWidth.current < 768) {
        setDottedDivisionWidth((avialableWidth.current * 80) / 100)
        imageHeight.current = ((avialableHeight.current * 50) / 100)
      }
      else {
        console.log("width greater than 768")
