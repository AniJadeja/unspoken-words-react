    ...
    <div>
      <div id='outerWrapper' className='rowWrapper grid grid-cols-1 xl:grid-cols-2 text-[var(--color-primary-white)] p-10 lg:px-20'>
        ...
        <div className='secondColumnWrapper'>
          ...
          <div className=''>
            <p id='projectDescription' className='text-sm md:text-base font-inter leading-loose tracking-[2px] text-justify mt-5' style={{ lineHeight: '1.8' }}>{project.description}</p>
          </div>
