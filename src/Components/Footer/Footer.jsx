...
const Footer = ({home}) => {
  return (
    ...
    <p className='mx-auto font-reef text-[var(--color-primary-gray)] align-center tracking-[4px] text-sm lg:text-lg xl:text-xl'>Project : {projectName}</p>
      <p className='mx-auto font-reef text-[var(--color-primary-gray)]  lg:flex lg:align-center tracking-[4px] text-sm lg:text-lg xl:text-xl'>Built from scratch by me .{")"}</p>
